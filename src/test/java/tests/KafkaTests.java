...
@SpringBootTest(classes = {JSONParser.class, KafkaProducerFactory.class, SendIncidence.class, SendIncidenceClass.class})
public class KafkaTests {
	...
	public void testJSON() {
		...
		assertEquals("{\"id\":0,\"identificadorAgente\":null,\"name\":null,\"descripcion\":null,"
